...
// Order: English, Беларуская, Català, Čeština, Deutsch, Español, Suomi, Français, Italiano, Polski, Português (Brasil), Română, Русский, Svenska, Українська
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {0, 11, 9, 4, 3, 1, 14, 2, 12, 13, 5, 8, 6, 7, 10};
