...
#endif  // ENABLE_FONT_BOOKERLY

// NotoSans fonts
#ifdef ENABLE_FONT_NOTOSANS
...
#endif  // ENABLE_FONT_NOTOSANS

// Small font uses notosans_8 (always included for UI elements)
EpdFont smallFont(&notosans_8_regular);
EpdFontFamily smallFontFamily(&smallFont);

// OpenDyslexic fonts
#ifdef ENABLE_FONT_OPENDYSLEXIC
...
#endif  // ENABLE_FONT_OPENDYSLEXIC

// Ubuntu UI fonts (always included for UI elements)
...
void setupDisplayAndFonts() {
  ...
  // Register small font (always included for UI)
  ...
  // Register Ubuntu UI fonts (always included)
